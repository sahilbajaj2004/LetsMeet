...
export const authOptions = {
  providers: [
    GoogleProvider({
      ...
      // NextAuth v4 defaults the OAuth HTTP timeout to 3500ms; Google's
      // token/userinfo round-trip exceeds that on slower networks, surfacing as
      // [SIGNIN_OAUTH_ERROR] "outgoing request timed out after 3500ms". Raise it.
