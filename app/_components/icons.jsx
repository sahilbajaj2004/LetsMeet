// Inline icons — no icon dependency. Stroke inherits currentColor.
...
// Google "G" brand mark — fixed brand colors, ignores currentColor.
...
export function LinkIcon({ className }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M9 15l6-6M10.5 6.5l1-1a4.95 4.95 0 0 1 7 7l-1 1M13.5 17.5l-1 1a4.95 4.95 0 0 1-7-7l1-1" />
    </svg>
  );
}
